...
const BANK = {
  ...
  Estudo: {
    "Métodos de estudo": [
      ...
      "Trabalho arduamente nos trabalhos acadêmicos em que me encontro envolvido/a."
    ],
    "Gestão do tempo": [
      ...
      "A minha incapacidade para gerir bem o tempo faz com que eu tenha más notas.",
    ...
    "Bases de conhecimentos para o curso": [
      ...
      "Sinto-me pouco ou mal preparado/a para frequentar este curso.",
  ...
  Institucional: {
    ...
    "Adaptação ao curso": [
      ...
      "Escolhi bem o curso que estou frequentando.",
    ...
    "Financeiro": [
      "Tenho dificuldade em fazer o curso face às exigências econômicas dele (computadores, rendas, bibliografia, materiais escolares, etc.).",
      ...
      "Para fazer face às minhas necessidades gostaria de ter um emprego extra.",
      "Não participo em algumas atividades de lazer por falta de dinheiro."
    ],
    "Relacionamento com Professores": [
      "Não é fácil para mim estabelecer contatos com os professores.",
      ...
      "Não tenho problemas em tirar dúvidas com os professores na sala de aula.",
  ...
  Interpessoal: {
    "Relacionamento com colegas": [
      ...
      "É difícil encontrar um colega que me ajude num problema pessoal.",
    ...
    "Relacionamento com a família": [
      ...
      "Mantenho um relacionamento afetuoso com a minha família.",
      ...
      "Os meus pais incentivam-me nos meus projetos acadêmicos.",
      "Sinto-me bem-vindo/a quando vou a casa.",
      "Tenho alguém na família em que posso confiar os meus problemas mais íntimos.",
      "Preciso falar com os meus pais sempre que me sinto desanimado/a ou triste.",
  ...
  Pessoal: {
    ...
    "Auto-confiança": [
      "Há situações em que me sinto a perder o controle.",
